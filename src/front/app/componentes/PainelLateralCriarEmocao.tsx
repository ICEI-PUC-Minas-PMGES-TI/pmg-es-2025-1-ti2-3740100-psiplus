...
import {X, Calendar, Clock, Edit2, Smile, Check, Save} from "lucide-react";
...
interface PainelLateralCriarEmocaoProps {
...
export default function PainelLateralCriarEmocao({
                                                      evento,
                                                      onClose,
                                                      pacienteId,
                                                      atualizarEventos,
                                                  }: PainelLateralCriarEmocaoProps) {
