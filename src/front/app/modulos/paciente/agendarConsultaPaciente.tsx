...
<Main>
  <div className="flex flex-col md:flex-row min-h-screen bg-white">
    ...
    <div className="flex-1 m-2 md:m-5">
      ...
      <div className="flex flex-col md:flex-row w-full mt-8 md:mt-12 md:ml-14 items-start gap-8">
        {/* Calendário Centralizado */}
        <div className="w-full md:w-[420px]">
          <div className="flex items-center justify-between text-lg font-semibold text-[#7D8DA6] mb-6 md:mb-10">
            <button
        ...
        {/* Linha vertical divisória só em desktop */}
