...
export default function EditarConsultaPaciente() {
  ...
  const fetchAvailableSlots = async () => {
    if (!psicologo.psicologoId || !pacienteId || !selectedDate) return;

    try {
      const dataISO = selectedDate.toISOString().split("T")[0];
      const url = `http://localhost:8080/consultas/horarios-disponiveis?psicologoId=${psicologo.psicologoId}&data=${dataISO}`;
  ...
  useEffect(() => {
    fetchAvailableSlots();
  }, [selectedDate, psicologo, pacienteId]);
  ...
  {loadingConsulta ? (
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-white">
      ...
      <div className="flex-1 m-2 md:m-5">
        ...
        <div className="flex flex-col md:flex-row mt-4 items-center justify-between flex-wrap gap-4">
          {/* Paciente */}
          <div className={"flex flex-col gap-2"}>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-lg font-medium text-gray-700">
                {consulta.psicologoNome || "Carregando..."}
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row w-full mt-12 md:ml-14 items-start gap-8">
          ...
          <div className="hidden md:block w-[1px] h-auto bg-[#DFE5F1] mx-8 self-stretch" />

          {/* Horários disponíveis */}
          <div className="w-full md:w-[300px] flex flex-col mt-8 md:mt-0">
            ...
            {/* Botão de Agendar */}
            <div className="w-full flex justify-end mt-10 pr-0 md:pr-10">
              <BotaoPadrao
